<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <!-- <el-table-column align="center" prop="content" label="申报人类型" style="width: 100px;">
        <template slot-scope="scope"> <span>{{scope.row.proposer_type}}</span></template>
      </el-table-column> -->
      ...
      <el-table-column align="center" prop="content" label="申请人" style="width: 100px;">
      ...
      <el-table-column align="center" prop="content" label="政府" style="width: 100px;">
      ...
      <el-table-column align="center" prop="content" label="首次成功人" style="width: 100px;">
        <template slot-scope="scope"> <span>{{find_employerin(scope.row.emp_success_id)}}</span></template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogCreateFormVisible">
      <el-form class="selectbox" :model="tempProject" label-position="left" label-width="100px"
        ...
        <el-form-item label="首次成功人">
          <el-input type="text" v-model="tempProject.emp_success_id">
          </el-input>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        this.api({
          url: "/declareProject/query",
          method: "get",
          params: this.listQuery
        }).then(data => {
           if(this.search_status==0){
            // console.log("search_s",data)
      ...
      for(let i=0;i<this.em_list.length;i++){
        console.log(this.em_list.length)
      ...
      this.tempDownload.id = this.tempProject.ruku_project_id;
      ...
      this.api({
        url: "/inboundProject/queryFiles"+ "?module="+ "2" ,
        method: "post",
      ...
      if (files.length > 0) {
        ...
        //  console.log(file)
        this.api({
          url: '/inboundProject/upload' + "?project_id="+ this.tempProject.ruku_project_id,
          method: 'post',
	  	    headers: {
      ...
      if (files.length > 0) {
        ...
        this.api({
          ...
          url: '/inboundProject/upload' + "?module="+ "2" + "&project_id="+ this.tempProject.ruku_project_id,
      ...
      if (this.searchkey != "") {
        ...
        for (let i = 0; i < this.beforsearch.length; i++) {
          ...
          let emp_s_name = this.find_employerin(this.beforsearch[i].emp_success_id)
          ...
          || per_name.includes(this.searchkey) || zc_title.includes(this.searchkey) || go_name.includes(this.searchkey) || emp_s_name.includes(this.searchkey)
      ...
      this.axios({
        method: 'get',
        url: "/api/inboundProject/download" + "?module="+ "2" + "&id="+ this.download_list[$index].id,
